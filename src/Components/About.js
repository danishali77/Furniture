                    ...
                    <div className="row justify-content-between">
                        ...
                        <div className="col-lg-7">
                            <div className="hero-img-wrap">
                                <img alt='images' src="images/couch.png" className="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row my-5">
                                <div className="col-6 col-md-6">
                                    <div className="feature">
                                        <div className="icon">
                                            <img alt='images' src="images/truck.svg"  className="imf-fluid" />
                                        </div>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                            <img alt='images' src="images/person_1.jpg" className="img-fluid mb-5" />
                        ...
                        <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                            <img alt='images' src="images/person_2.jpg" className="img-fluid mb-5" />
                        ...
                        <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                            <img alt='images' src="images/person_3.jpg" className="img-fluid mb-5" />
                        ...
                        <div className="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                            <img alt='images' src="images/person_4.jpg" className="img-fluid mb-5" />
