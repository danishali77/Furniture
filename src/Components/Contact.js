                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-5">
                            <div className="intro-excerpt">
                                ...
                                <p><Link href="" className="btn btn-secondary me-2">Shop Now</Link><Link href="#" className="btn btn-white-outline">Explore</Link></p>
                            </div>
                        </div>
                            ...
                            <div className="col-md-8 col-lg-8 pb-4">
                                ...
                                <form>
                                    ...
                                    <div className="form-group mb-5">
                                        ...
                                        <textareLink name="" className="form-control" id="message" cols="30" rows="5"></textareLink>
                                    </div>
