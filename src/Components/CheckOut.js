                        ...
                        <div className="col-md-6 mb-5 mb-md-0">
                            ...
                            <div className="p-3 p-lg-5 border bg-white">
                                ...
                                <div className="form-group">
                                    ...
                                    <textareLink name="c_order_notes" id="c_order_notes" cols="30" rows="5" className="form-control" placeholder="Write your notes here..."></textareLink>
                                </div>
                                ...
                                <div className="col-md-12">
                                    ...
                                    <div className="p-3 p-lg-5 border bg-white">
                                        ...
                                        <div className="border p-3 mb-3">
                                            <h3 className="h6 mb-0"><Link className="d-block" data-bs-toggle="collapse" href="#collapsebank" role="button" aria-expanded="false" aria-controls="collapsebank">Direct Bank Transfer</Link></h3>
                                        ...
                                        <div className="border p-3 mb-3">
                                            <h3 className="h6 mb-0"><Link className="d-block" data-bs-toggle="collapse" href="#collapsecheque" role="button" aria-expanded="false" aria-controls="collapsecheque">Cheque Payment</Link></h3>
                                        ...
                                        <div className="border p-3 mb-5">
                                            <h3 className="h6 mb-0"><Link className="d-block" data-bs-toggle="collapse" href="#collapsepaypal" role="button" aria-expanded="false" aria-controls="collapsepaypal">Paypal</Link></h3>
